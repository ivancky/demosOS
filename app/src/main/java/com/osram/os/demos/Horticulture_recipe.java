...
public class Horticulture_recipe extends AppCompatActivity {
    Handler handler;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mBluetoothConnection = new BluetoothConnectionService(Horticulture_recipe.this);
        ...
        adapterViewPager = new Horticulture_recipe.MyPagerAdapter3(getSupportFragmentManager());
    ...
    // replace frame layout with fragment
        ...
        ft.replace(R.id.frameLayout, new Horti_recipe_fragment_container());
        ft.commit();
