...
public class Horticulture_recipe_HP extends AppCompatActivity {
    Handler handler;
    ...
    private Horti_recipe_fragment_container_HP mFragement2;
            ...
            switch (item.getItemId()) {
                case R.id.navigation_home:
                    ...
                    handler.post(new Runnable() {
                        public void run() {
                            Intent intent = new Intent(Horticulture_recipe_HP.this, Horticulture_HP.class);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mBluetoothConnection = new BluetoothConnectionService(Horticulture_recipe_HP.this);
        ...
        adapterViewPager = new Horticulture_recipe_HP.MyPagerAdapter3(getSupportFragmentManager());
    ...
    // replace frame layout with fragment
        ...
        ft.replace(R.id.frameLayout, new Horti_recipe_fragment_container_HP());
        ft.commit();
